...
public  class InfoTravelEntity implements Serializable {
    ...
    public void setClientM(String clientM) {
    ...
    public void setAmountToll(String amountToll) {
    ...
    public void setAmountParking(String amountParking) {
    ...
    public void setAmountTimeSleep(String amountTimeSleep) {
    ...
    public void setCantHours(String cantHours) {
