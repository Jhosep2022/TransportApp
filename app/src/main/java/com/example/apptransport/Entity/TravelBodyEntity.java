...
public class TravelBodyEntity {
    ...
    public TravelBodyEntity(int idClientKf,
                            boolean isTravelComany,
                            OriginEntity origin,
                            DestinationEntity dstination,
                            String dateTravel,
                            int idTypeVehicle,
                            boolean isTravelSendMovil,
                            int idUserCompanyKf,
                            String hoursAribo,
                            String   terminal,
                            String  airlineCompany,
                            String flyNumber,
                            int isFleetTravelAssistance,
                            boolean isFleetTravel,
                            double distanceLabel,
                            double distance,
                            String amountDisplay,
                            String originObs,
                            int isPointToPoint,
                            double amountOriginPac) {
