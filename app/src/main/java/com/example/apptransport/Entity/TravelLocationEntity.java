...
public class TravelLocationEntity {
    ...
    public TravelLocationEntity(int idUser,int idTravelKf, String location, String longLocation,
                                ...
                                int idUserCompanyKf, int idSatatusTravel
        ...
        this.idUserCompanyKf=idUserCompanyKf;
    ...
    public TravelLocationEntity(int idTravelKf, Double totalAmount, Double distanceGps, String distanceGpsLabel,
                                ...
                                double amountFleet,double distanceGpsReturn, String durationOfTravelByHour, double finalIVA, double ePayDiffAmount , String ePayDiffPercent, int isKmWithError ) {
        this.idTravelKf = idTravelKf;
        ...
        this.distanceGpsReturn = distanceGpsReturn;
        this.cantHoursFn = durationOfTravelByHour;
        this.finaliva=finalIVA;
        this.ePayDiffAmount=ePayDiffAmount;
        this.ePayDiffPercent=ePayDiffPercent;
        this.isKmWithError = isKmWithError;
    }
    ...
    public int getIdUserCompanyKf() {
        return idUserCompanyKf;
    }

    public void setIdUserCompanyKf(int idUserCompanyKf) {
        this.idUserCompanyKf = idUserCompanyKf;
    }
    ...
    public void setCantHoursFn(String cantHoursFn) {
        this.cantHoursFn = cantHoursFn;
    }
    ...
    public void setFinaliva(Double finaliva) {
        this.finaliva = finaliva;
    }

    public Double getePayDiffAmount() {
        return ePayDiffAmount;
    }

    public void setePayDiffAmount(Double ePayDiffAmount) {
        this.ePayDiffAmount = ePayDiffAmount;
    }

    public String getePayDiffPercent() {
        return ePayDiffPercent;
    }

    public void setePayDiffPercent(String ePayDiffPercent) {
        this.ePayDiffPercent = ePayDiffPercent;
    }

    public int getIsKmWithError() {
        return isKmWithError;
    }

    public void setIsKmWithError(int isKmWithError) {
        this.isKmWithError = isKmWithError;
    }
}
